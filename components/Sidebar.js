...
allBtn.className = "pill" + (state.filters.topic === null ? " pill-active" : "");
...
const completedLessonsCount = Object.keys(state.progress.completedLessons).length;
...
document.querySelectorAll("#levelFilter .pill").forEach(b => b.classList.remove("pill-active"));
