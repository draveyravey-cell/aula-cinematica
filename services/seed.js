export const initialLessons = () => [
  {
    ...
    description:
      "Conceitos fundamentais de movimento em linha reta, posição, deslocamento, velocidade média e vetores de posição.",
  ...
  },
  {
    ...
    description:
      "Velocidade constante, equações horárias e gráficos posição x tempo.",
  ...
  },
  {
    ...
    description:
      "Velocidade variável, aceleração constante e equações do MRUV.",
  ...
  },
  {
    ...
    topics: ["vetores"],
    description:
      "Deslocamento, velocidade e aceleração vetoriais; soma e decomposição.",
    videoUrl: "",
    interactiveUrl:
  ...
  },
  {
    ...
    description: "Velocidade angular, frequência e aceleração centrípeta.",
  ...
  },
  {
    ...
    description:
      "Decomposição em duas dimensões; alcance, altura máxima e tempo de voo.",
...
export const initialQuizzes = () => [
  {
    id: "quiz-mru",
    lessonId: "basico-mru",
    question: "Em um MRU, qual afirmação é verdadeira?",
    options: {
  ...
  },
  {
    ...
    question: "No MRUV, o gráfico velocidade x tempo é:",
    options: {
      A: "Reta horizontal",
      B: "Reta inclinada",
      C: "Parábola",
    ...
    correct: "B",
    explanation:
      "A aceleração constante implica variação linear da velocidade.",
  },
  {
    id: "quiz-lancamento",
    lessonId: "avancado-lancamento-obliquo",
    question: "No lançamento oblíquo sem ar, a aceleração é:",
    options: {
    ...
    correct: "B",
    explanation: "A única aceleração é a gravidade, vertical para baixo.",
  },
];
